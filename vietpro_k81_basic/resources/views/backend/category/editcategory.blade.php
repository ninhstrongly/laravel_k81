										...
										<div class="form-group">
											<div class="form-group">
												...
												<select class="form-control" name="parent" >
													...
													{{ GetCategory($categorys,0,'',$category->parent) }}
												</select>
											</div>
											...
											@if(session('coincide_category'))
												<div class="alert bg-danger" role="alert">
													<svg class="glyph stroked cancel">
														<use xlink:href="#stroked-cancel"></use>
													</svg>{{ session('coincide_category') }}<a href="#" class="pull-right"><span class="glyphicon glyphicon-remove"></span></a>
												</div>
											@endif()
										</div>
