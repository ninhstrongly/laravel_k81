						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}">
									<label for="menu" class="selected-menu">Chọn Meunu bạn muốn thay đổi:</label>
									...
									<span class="add-new-menu-action"> or <a href="{{ $currentUrl }}?action=edit&menu=0">Tạo mới Menu</a>. </span>
								</form>
							</div>
										...
										<div id="side-sortables" class="accordion-container">
											<ul class="outer-border">
												<li class="control-section accordion-section  open add-page" id="add-page">
													<h3 class="accordion-section-title hndle" tabindex="0"> Chỉnh sửa Link <span class="screen-reader-text">Press return or enter to expand</span></h3>
												...
												<div id="post-body">
													<div id="post-body-content">
														...
														<div class="drag-instructions post-body-plain" style="">
															...
															Đặt từng mục theo thứ tự bạn thích. Nhấp vào mũi tên bên phải của mục để hiển thị thêm tùy chọn cấu hình..
															</p>
														</div>
														...
														<div class="drag-instructions post-body-plain" style="">
															<p>
																	Vui lòng nhập tên và chọn nút "Tạo menu"
															</p>
														</div>
														@endif
